...
\newcounter{allResults}\numberwithin{allResults}{chapter}
% THEOREM-LIKE
% Theorem; red border all round, grey background
\crefformat{tcb@cnt@tcbtheo}{Theorem~#2#1#3}
\newtcbtheorem[number within=chapter]{tcbtheo}{Theorem}%
...
\crefformat{tcb@cnt@tcbcorollary}{Corollary~#2#1#3}
...
\crefformat{tcb@cnt@tcblemma}{Lemma~#2#1#3}
...
\crefformat{tcb@cnt@tcbproposition}{Proposition~#2#1#3}
\newtcbtheorem[use counter from=tcbtheo, crefname={proposition}{Proposition}, Crefname={Proposition}{Proposition}]{tcbproposition}{Proposition}%
     {fonttitle=\sffamily\bfseries\color{resultColor},
      separator sign dash, description color=black,
      top=2pt, bottom=2pt,
      sharp corners,
